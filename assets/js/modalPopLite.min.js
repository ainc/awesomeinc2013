	...
	e.fn.modalPopLite=function(n){
		...
		return this.each(function(){
			...
			e(o).on("click",function(t){
				...
				e("#modalPopLite-wrapper"+r).css({left:a+"px",top:f});
				e("#modalPopLite-wrapper"+r).fadeIn("slow");i=true});
				e(u).on("click",function(t){
					t.preventDefault();
					e("#modalPopLite-mask"+r).hide();
					e("#modalPopLite-wrapper"+r).css("left","-10000px");
					i=false;if(n.callBack!=null){
						n.callBack.call(this)}
					});
				if(!a){e("#modalPopLite-mask"+r).click(function(t){
				...
				if(i){
					...
					var u=t/2-s/2;var a=n/2-o/2;
					e("#modalPopLite-wrapper"+r).css({left:u+"px",top:a});
